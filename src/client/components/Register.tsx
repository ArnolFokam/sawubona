...
export default function Register() {
    ...
    const handleSubmit: React.FormEventHandler<HTMLFormElement> = async (e) => {
        ...
        if (isValid) {
            setIsLoading(true);
            try {
                const _ = await register({ email, password });
    ...
    return (
        <div className="container mx-auto px-4 py-8"> {/* Basic container layout */}
            <h1 className="text-3xl font-bold text-center mb-8">Register</h1> {/* Styled title */}
